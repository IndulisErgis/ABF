...
CREATE VIEW dbo.trav_ArHistorySales_view
AS
...
--PET:http://webfront:801/view.php?id=238166
	...
	SELECT h.PostRun,h.BatchId,h.SoldToID, h.ShipToID, h.InvcNum, h.InvcDate, h.TransId, h.CustId, 
		...
		d.EntryNum, d.WhseId AS LocId, d.PartId AS ItemId, d.ItemJob, d.CatId, d.JobId, d.GLAcctSales,
...
GO
EXECUTE sp_addextendedproperty @name = N'Version', @value = '11.0.19137.3213', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'trav_ArHistorySales_view';


GO
EXECUTE sp_addextendedproperty @name = N'Comment', @value = 'Build 19137', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'trav_ArHistorySales_view';
