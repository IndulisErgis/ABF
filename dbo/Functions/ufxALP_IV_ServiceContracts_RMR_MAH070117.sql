...
CREATE FUNCTION [dbo].[ufxALP_IV_ServiceContracts_RMR_MAH070117]   
(
@pAsOfDate date 
)  
RETURNS TABLE   
...
(  
  ...
  -- AND (([rbs].[CanServEndDate] is NULL) OR ( [rbs].[CanServEndDate] >=  '07/07/2017'))  -- @AsOfDate ))
   ...
   --ORDER BY RB.SiteId,rbs.SysId,  RBS.ServiceID, P.StartBillDate  
   )
