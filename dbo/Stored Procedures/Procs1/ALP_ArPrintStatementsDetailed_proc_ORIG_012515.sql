CREATE PROCEDURE [dbo].[ALP_ArPrintStatementsDetailed_proc_ORIG_012515]        
@CutoffDate datetime,         
...
BEGIN TRY        
 ...
 --CREATE TABLE #CustomerList (CustId pCustId, PRIMARY KEY (CustId))      
 --INSERT INTO #CustomerList (CustId) SELECT CustID from dbo.tblArCust where GroupCode = 'C' OR GroupCode = 'A'--CustID = '001648'        
