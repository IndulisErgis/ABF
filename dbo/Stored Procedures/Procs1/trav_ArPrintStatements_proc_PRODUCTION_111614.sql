...
CREATE PROCEDURE [dbo].[trav_ArPrintStatements_proc_PRODUCTION_111614]
@CutoffDate datetime, 
...
BEGIN TRY
	...
	SELECT @StatementDate AS StatementDate, @ClosingDate AS ClosingDate, @CutoffDate AS CutoffDate
		...
		--mah use AlpCustFullName instead of just traverse CustName - 08/20/14
	...
	--mah 08/20/2014 - added Alp Cust table to get FirstName
