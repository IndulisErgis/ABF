CREATE Procedure [dbo].[ALP_qryJm110r00RecurBills_sp_TESTDMM]                   
...
INSERT INTO #SiteServices ( RecBillServId,RecBillServPriceId, BilledThruDate,LastOfRecBillServPriceId, EndBillDate, TotActiveRMR )                  
 (
SELECT billServ.RecBillServId, servPrice.RecBillServPriceId, billServ.BilledThruDate, 
servPriceFP.RecBillServPriceId, servPrice.EndBilldate
, 0            
from
	...
	left outer join ALP_tblArAlpSiteRecBillServPrice servPrice2
		...
		and servPrice.RecBillServPriceId > servPrice2.RecBillServPriceId
	left outer join ALP_tblArAlpSiteRecBillServPrice servPriceFP
		on servPriceFP.RecBillServPriceId =		(
													...
													where
														...
														and sp.StartBillDate is not NULL
														AND sp.StartBillDate > servPrice.EndBillDate
													order by sp.StartBillDate desc
													)
where
...
UPDATE #SiteServices                  
  ...
  --where #SiteServices.EndBillDate is null
...
SET @TotActiveRMR = (SELECT SUM(ISNULL(S.ActivePrice,0))                  
  ...
  AND (EndBillDate is null or EndBillDate > getdate())
...
--get ALP_tblArAlpSiteRecBillServPrice.RecBillServPriceId showing futore price
