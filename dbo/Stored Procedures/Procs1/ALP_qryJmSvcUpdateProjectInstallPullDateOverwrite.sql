...
CREATE PROCEDURE [dbo].[ALP_qryJmSvcUpdateProjectInstallPullDateOverwrite]                        
 @ID varchar(10),    
 @PullDate datetime ,      
...
WHERE ALP_tblJmSvcTkt.ProjectId = '''+ @ID + ''' AND                 
(ALP_tblJmResolution.[Action] =''Add'' Or ALP_tblJmResolution.[Action] =''Replace'')                       
