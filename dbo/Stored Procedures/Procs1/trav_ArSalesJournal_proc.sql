...
CREATE PROCEDURE dbo.trav_ArSalesJournal_proc
@SortBy tinyint = 1,
...
BEGIN
	...
	, h.BatchId, h.TransId, h.TransType, h.CustId, c.CustName, h.ShipToID, h.TermsCode, h.InvcNum, h.CustPONum
	, h.OrderDate, h.ShipDate, h.InvcDate, h.Rep1Id, h.Rep1Pct, h.Rep2Id, h.Rep2Pct, h.TaxClassFreight
	...
	SELECT 1 AS RecType
		...
		, h.ShipToID, h.TermsCode, h.InvcNum, h.CustPONum, h.OrderDate, h.ShipDate, h.InvcDate
	...
	FROM #tmpTransactionList t INNER JOIN dbo.tblArTransHeader h ON t.TransId = h.TransId
		INNER JOIN #tmpCustomerList c ON h.CustId = c.CustId
		INNER JOIN dbo.tblArTransLot l ON h.TransId = l.TransId
	WHERE h.TransType = 1 AND h.VoidYn = 0 AND (@PrintAllInBase = 1 OR h.CurrencyId = @ReportCurrency)
	ORDER BY LotNum
...
END CATCH
GO
EXECUTE sp_addextendedproperty @name = N'Version', @value = '11.0.19137.3213', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'PROCEDURE', @level1name = N'trav_ArSalesJournal_proc';


GO
EXECUTE sp_addextendedproperty @name = N'Comment', @value = 'Build 19137', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'PROCEDURE', @level1name = N'trav_ArSalesJournal_proc';
