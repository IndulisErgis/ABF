CREATE Procedure [dbo].[ALP_qryIMPUpdateImpItemandMain] ( @pImportItemId int,@pTicketId int,
	--Below @ModifiedBy  parameter length changed from 16 to 50 char, modified by ravi on 03 May 2017
	@pModifiedBy varchar(50)
	)AS
