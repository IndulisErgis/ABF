CREATE PROCEDURE [dbo].[ALP_ArPrintStatementsDetailed_proc_MAHTEST]    
@CutoffDate datetime,     
...
BEGIN TRY    
 ...
 CREATE TABLE #CustomerList (CustId pCustId, PRIMARY KEY (CustId))  
 INSERT INTO #CustomerList (CustId) SELECT CustID from dbo.tblArCust where CustID = '106330'    
 ...
 (    
   ...
   AlpSiteAddr1 varchar(40),  
   AlpSiteAddr2 varchar(60),
   PRIMARY KEY (CustId, InvcNum, AlpSiteId)     
 )        
 ...
 --MAH 11/18/14 - summary of invoices - and primary SiteID to be assigned 
  ...
  SET AlpSiteName = alpS.SiteName, AlpSiteAddr1 = alpS.Addr1, AlpSiteAddr2 = alpS.Addr2
