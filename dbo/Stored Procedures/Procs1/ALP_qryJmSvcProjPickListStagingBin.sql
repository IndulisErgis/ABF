CREATE PROCEDURE [dbo].[ALP_qryJmSvcProjPickListStagingBin]                    
 @ProjID varchar(10) ,                  
...
SET ALP_tblJmSvcTkt.BinNumber = ''' + @BinNumber + ''',          
ModifiedBy=''' + @ModifiedBy + ''',ModifiedDate=''' + @ModifiedDate +'''          
FROM   ALP_tblJmSvcTkt                  
WHERE (BinNumber='''' or BinNumber is null) and ALP_tblJmSvcTkt.ProjectId ='''+ @ProjID+'''                    
