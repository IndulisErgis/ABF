 -- need:  a.AlpSiteId, a.SiteName, a.SiteAddr1, a.SiteAddr2 
CREATE PROCEDURE [dbo].[ALP_ArPrintStatements_proc]  
@CutoffDate datetime,   
...
BEGIN TRY  
 ...
 --CREATE TABLE #CustomerList (CustId pCustId, PRIMARY KEY (CustId))
 --INSERT INTO #CustomerList (CustId) SELECT CustID from dbo.tblArCust where CustID = '000000'  
