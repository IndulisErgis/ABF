CREATE PROCEDURE [dbo].[ALP_qryJmSvcTktUpdateBilledInvc]	
@BilledYn bit,
@InvcNum varchar(15),
@TicketId int,
...
AS
Update ALP_tbljmsvctkt set BilledYn=@BilledYn,InvcNum=@InvcNum,RevisedBy=@RevisedBy,RevisedDate=CONVERT(VARCHAR(10),GETDATE(),101)
