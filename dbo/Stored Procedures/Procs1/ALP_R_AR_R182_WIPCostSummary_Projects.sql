...
CREATE PROCEDURE [dbo].[ALP_R_AR_R182_WIPCostSummary_Projects]
	@EndDate dateTime
AS
BEGIN
SET NOCOUNT ON;
...
SUM(ISNULL(qry3M.OtherCostExt,0)) AS OtherMiscCost,
SUM(ISNULL(qry3P.OtherCostExt,0)) AS OtherPartCost
