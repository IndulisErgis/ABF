CREATE PROCEDURE [dbo].[ALP_lkpJmSvcTktItemNewSysItems_sp]        
 @SysId int        
As        
SET NOCOUNT ON        
SELECT ALP_tblArAlpSiteSysItem.ItemId, ALP_tblArAlpSiteSysItem.[Desc],      
 ...
 ALP_tblArAlpSiteSysItem.Zone, ALP_tblArAlpSiteSysItem.SysItemId as NewSysItemId, ALP_tblArAlpSiteSysItem.Qty  
