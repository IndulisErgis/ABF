CREATE Procedure [dbo].[ALP_qryJmIN_InventoryIntegrityCheckWithRpt_sp]     
AS     
--SET NOCOUNT ON     
    
SET IDENTITY_INSERT tblInQty ON    
--0.  FIND ALL Parts with MULTIPLE InQty records    
select ALP_tblJmSvcTktItem.TicketItemId, Count(tblInQty.LinkIdSub) as RecCount INTO #tmpDuplicates_InQty    
