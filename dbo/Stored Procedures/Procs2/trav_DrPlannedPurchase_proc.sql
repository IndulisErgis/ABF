...
Create Procedure dbo.trav_DrPlannedPurchase_proc
(
	@WksDate Datetime,
	@RunId pPostRun,
	@PdDefId nvarchar(10),
...
Declare @rowNo Int
	...
	Insert into #PdQtys(ItemId, LocId, PdDate, SOCmtd, MfCmtd, MpCompReq, MfCompReq
				, MpOnOrder, PoOnOrder, PoPurReq, WmOnOrder, JcCmtd,MasterScheduledProduction)
	Select t.ItemId, t.LocId, d.IncDate
		...
		,Sum(Case When t.Source = 128 Then t.Qty Else 0 End) 
	...
	Begin
		...
		-- Can't generate planned receipts earlier than today and/or the specified time fence
	...
	Select d.ItemId, d.LocId, i.Descr, l.DfltVendId, v.[Name] VendorName, Cast(l.DfltLeadTime as float) LeadTime
		...
		left join dbo.tblApVendor v on l.DfltVendId = v.VendorId
		Where isnull(d.PlanRcpts, 0) > 0
		Order by d.ItemId, d.LocId, d.PdDate
		
		--Sub report's data
		SELECT ItemId, LocId, VendId, VendName, LastPOUnitCost, LastPoDate, LeadTime FROM dbo.tblInItemLocVend
...
END CATCH
GO
EXECUTE sp_addextendedproperty @name = N'Version', @value = '11.0.19137.3213', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'PROCEDURE', @level1name = N'trav_DrPlannedPurchase_proc';


GO
EXECUTE sp_addextendedproperty @name = N'Comment', @value = 'Build 19137', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'PROCEDURE', @level1name = N'trav_DrPlannedPurchase_proc';
