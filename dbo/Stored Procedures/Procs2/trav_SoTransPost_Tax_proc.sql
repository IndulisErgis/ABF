...
CREATE PROCEDURE dbo.trav_SoTransPost_Tax_proc
AS
SET NOCOUNT ON
BEGIN TRY
	...
	Select t.TaxLocID, t.TaxClass
		, @PostRun, 'SO', t.TransID, NULL, NULL
	...
	Select h.TaxLocAdj, h.TaxClassAdj
		, @PostRun, 'SO', h.TransID, NULL, NULL
		, h.InvcDate, h.GLPeriod, h.FiscalYear
		, 0, 0
...
END CATCH
GO
EXECUTE sp_addextendedproperty @name = N'Version', @value = '11.0.19137.3213', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'PROCEDURE', @level1name = N'trav_SoTransPost_Tax_proc';


GO
EXECUTE sp_addextendedproperty @name = N'Comment', @value = 'Build 19137', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'PROCEDURE', @level1name = N'trav_SoTransPost_Tax_proc';
