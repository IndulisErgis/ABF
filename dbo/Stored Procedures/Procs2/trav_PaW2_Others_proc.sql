...
CREATE PROCEDURE [dbo].[trav_PaW2_Others_proc]
@PaYear smallint
AS
BEGIN TRY
...
SELECT EmployeeID, sum(Amount) AS Amount, Convert(nvarchar(2),'A') AS Description 
INTO #tmpBox13
...
INSERT INTO #tmpBox13
SELECT e.EmployeeID, Sum(e.Amount) Amount, LEFT(c.W2Code,2)  Description
...
END CATCH
GO
EXECUTE sp_addextendedproperty @name = N'Version', @value = '11.0.19137.3213', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'PROCEDURE', @level1name = N'trav_PaW2_Others_proc';


GO
EXECUTE sp_addextendedproperty @name = N'Comment', @value = 'Build 19137', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'PROCEDURE', @level1name = N'trav_PaW2_Others_proc';
